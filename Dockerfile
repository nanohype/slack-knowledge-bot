...
# OTLP target is the cluster's OpenTelemetry Collector gateway at
# telemetry.monitoring.svc.cluster.local:4318 (set via OTEL_EXPORTER_OTLP_ENDPOINT in the chart).
